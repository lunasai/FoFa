...
const DEFAULT_SEMANTIC_COLOR_TOKENS = [
  ...
  { id: 'color.bg.brand.strong',       paletteId: 'brand',  step: 800, description: 'Brand strong — dark emphasis fills',
    concept: { category: 'bg', role: 'brand' } },
...
const DEFAULT_SHAPES = {
  ...
  semantic: [
    { id: 'radius.button',  step: 'md',   type: 'rounded',  description: 'Default button radius',
      concept: { role: 'button',  isScale: false } },
    { id: 'radius.input',   step: 'md',   type: 'rounded',  description: 'Form input radius',
      concept: { role: 'input',   isScale: false } },
    { id: 'radius.card',    step: 'lg',   type: 'rounded',  description: 'Card and panel radius',
      concept: { role: 'card',    isScale: false } },
    { id: 'radius.badge',   step: 'full', type: 'rounded',  description: 'Badge and chip radius',
      concept: { role: 'badge',   isScale: false } },
    { id: 'radius.avatar',  step: 'full', type: 'squircle', smoothing: 0.6, description: 'Avatar radius',
      concept: { role: 'avatar',  isScale: false } },
    { id: 'radius.modal',   step: 'xl',   type: 'rounded',  description: 'Modal and dialog radius',
      concept: { role: 'modal',   isScale: false } },
    { id: 'radius.tooltip', step: 'sm',   type: 'rounded',  description: 'Tooltip radius',
